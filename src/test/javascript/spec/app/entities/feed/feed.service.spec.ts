    ...
    describe('Feed Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/feeds';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Feed', () => {
                service.create(new Feed(null)).subscribe(received => {
            ...
            it('should update a Feed', () => {
                service.update(new Feed(123)).subscribe(received => {
