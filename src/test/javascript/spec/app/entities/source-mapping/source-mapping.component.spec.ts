...
import { SourceMappingComponent } from 'app/entities/source-mapping/source-mapping.component';
...
describe('Component Tests', () => {
    describe('SourceMapping Management Component', () => {
        let comp: SourceMappingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SourceMappingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sourceMappings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
